...
<div class="container" style="float:left;">
	<div class="login">
	<form method="POST" action="ashierslog.php">
...
PASSWORD<br><input type="password" name="password" class="txt11" required><br><br>
<button>SIGN IN</button>

	</form></center><center>
		Use member number as default username and password. to change your password  <a href="ashierpass.php">click here</a>
